...
Las propiedades de clase son variables que, en lugar de necesitar de una instancia (objeto) para existir, dependerán únicamente de la clase. Para definirlas hemos de preceder la declaración de la variable de la palabra reservada `static`:
